# SQLThinkRS PowerShell Module - Windows (.dll)
...
function Initialize-NativeLibrary {
    ...
    $dllPath = Join-Path $PSScriptRoot 'sqlthinkrs.dll'
    if (-not (Test-Path $dllPath)) {
        throw "SQLThinkRS native library not found at '$dllPath'. Copy sqlthinkrs.dll from target\release\ into the module folder."
    }
